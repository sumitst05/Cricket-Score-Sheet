...
void print_team1_details(int x, int y) {
  ...
  for (int i = 0; i < x; i++) {
    printf("%s %5d %7d %9d %10d %8d %12d\n\n", batsman_t1[i].name,
           batsman_t1[i].ones, batsman_t1[i].twos, batsman_t1[i].threes,
           batsman_t1[i].fours, batsman_t1[i].sixes, batsman_t1[i].balls);
  }
  printf(
      "==================================================================\n");
  ...
  printf(
      "------------------------------------------------------------------\n");
  for (int i = 0; i < y; i++) {
    printf("%s %5d %11d %13d\n\n", bowler_t1[i].name, bowler_t1[i].wickets,
           bowler_t1[i].runs_given, bowler_t1[i].overs);
  }
  printf(
      "==================================================================\n");
}
...
void print_team2_details(int x, int y) {
  ...
  for (int i = 0; i < x; i++) {
    printf("%s %5d %7d %9d %10d %8d %12d\n\n", batsman_t2[i].name,
           batsman_t2[i].ones, batsman_t2[i].twos, batsman_t2[i].threes,
           batsman_t2[i].fours, batsman_t2[i].sixes, batsman_t2[i].balls);
  }
  printf(
      "==================================================================\n");
  ...
  printf(
      "------------------------------------------------------------------\n");
  for (int i = 0; i < y; i++) {
    printf("%s %5d %11d %13d\n\n", bowler_t2[i].name, bowler_t2[i].wickets,
           bowler_t2[i].runs_given, bowler_t2[i].overs);
  }
  printf(
      "==================================================================\n");
}
...
void print_summary(int x, int y) {
  ...
  printf("#################################################################\n");
  printf("#################################################################\n");
  printf("Highest runs scored by team 2 : %d\n", batsman_t2->max_runs);
  printf("Maximum fours scored by team 2 : %d\n", batsman_t2->max_fours);
  printf("Maximum sixes scored by team 2 : %d\n", batsman_t2->max_sixes);
  printf("Maximum wickets taken by team 2 : %d\n", bowler_t2->max_wickets);
  printf("#################################################################\n");
}
